...
#define rot_num 16
ap_fixed<26,2> GainReciprocal[NO_ITER] ={0.707106781,0.632455532,0.613571991,0.608833913,0.607648256,0.607351770,0.607277644,0.607259112,0.607254479,0.607253321,0.607253032,0.607252959,0.607252941,0.607252937,0.607252935,0.607252935};
...
#pragma HLS INTERFACE ap_vld port=x
	ap_fixed<27,3> xfix=x,temp=0,thetares=0;
	ap_fixed<25,1> yfix=y;
	ap_fixed<26,2> gaintemp=GainReciprocal[rot_num-1];
	ap_fixed<26,2>xtemp=0;
	if(xfix<0){
		if(yfix>0){
